...
import { isSameTabOutboundHref } from "@/lib/affiliate-outbound";
  ...
  return (
    <div>
      ...
      <div className="grid gap-2 sm:grid-cols-2">
        {links.map((link) => {
          // ふるなび（/out/*）は VC の JS 中間ページが新しいタブで止まりやすいので同じタブで開く
          const openInSameTab = isSameTabOutboundHref(link.href);
            ...
            <a
              ...
              onClick={() =>
                sendGaEvent("affiliate_click", {
                  ...
                  link_url: link.href,
                  ...(openInSameTab ? { transport_type: "beacon" } : {}),
                })
              }
              className={cn(
